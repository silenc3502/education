#set_property PACKAGE_PIN T17 [get_ports {gpio_rtl_tri_io[0]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {gpio_rtl_tri_io[0]}]

set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports { gpio_rtl_tri_io[0] }]; #IO_L20P_T3_34 Sch=je[9]                     
